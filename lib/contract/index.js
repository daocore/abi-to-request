...
export var ContractRequestContextProvider = function (_a) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!((_b = library) === null || _b === void 0 ? void 0 : _b.eth)) return [3, 1];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    contracts = {};
                    sendAccounts = [];
                    if (!((_a = library) === null || _a === void 0 ? void 0 : _a.eth)) return [3, 2];
                    return [4, ((_b = library) === null || _b === void 0 ? void 0 : _b.eth.getAccounts())];
                case 1:
                    sendAccounts = _c.sent();
                    _c.label = 2;
                case 2:
                    i = 0;
                    _c.label = 3;
    ...
    useEffect(function () {
        if (!library)
            return;
        var lib = library;
        var isWeb3 = (lib === null || lib === void 0 ? void 0 : lib.eth) && (lib === null || lib === void 0 ? void 0 : lib.bzz);
        if (isWeb3 && (lib === null || lib === void 0 ? void 0 : lib.currentProvider)) {
            subscribeProvider(lib === null || lib === void 0 ? void 0 : lib.currentProvider);
        }
        if (isWeb3) {
            lib === null || lib === void 0 ? void 0 : lib.eth.getChainId().then(function (chainId) {
                setNetworkId(parseInt("".concat(chainId)));
            });
        }
        else {
            lib === null || lib === void 0 ? void 0 : lib.getNetwork().then(function (net) {
