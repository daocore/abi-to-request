        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!contracts)
                        return [2];
                    contract = contracts[fetch === null || fetch === void 0 ? void 0 : fetch.contract];
                    if (!contract)
                        return [2];
                    name = { functionName: fetch === null || fetch === void 0 ? void 0 : fetch.name, contractName: fetch === null || fetch === void 0 ? void 0 : fetch.contract };
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
                    ...
                    return [4, (fetch === null || fetch === void 0 ? void 0 : fetch.fun(contract, arg))];
                case 2:
                    res = _d.sent();
...
export var useRequest = function (fetch, option, rely) {
    ...
    var contract = contracts && contracts[fetch === null || fetch === void 0 ? void 0 : fetch.contract] ? contracts[fetch === null || fetch === void 0 ? void 0 : fetch.contract] : undefined;
...
export var useReadContractRequest = function (fetch, option, rely) {
    if (option === void 0) { option = {}; }
    if (rely === void 0) { rely = []; }
    var _a = useState(), returnValue = _a[0], setReturnValue = _a[1];
    var contracts = useContractRequest().contracts;
    ...
    useEffect(function () {
        if (!contract)
            return;
        getFun();
    }, __spreadArray([contract], rely, true));
