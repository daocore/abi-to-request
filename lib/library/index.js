        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 10:
                    ...
                    setWeb3Info(function (pre) { return (__assign(__assign({}, pre), { library: library, connected: isUndefined(defaultProvider), address: address, chainId: chainId, networkId: chainId, balance: balance })); });
                    return [2];
            }
        });
    }); };
