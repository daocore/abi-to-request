...
//view
export const PixelsMetaverseAbis1_Amount = async (
	contract: TContract,
) => {
...
//view
export const PixelsMetaverseAbis1_BaseInfo = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverseAbis1_Collection = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverseAbis1_Composes = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverseAbis1_Material = async (
	contract: TContract,
	arg?: {
		uint256Params1: string | number; //uint256
	}
...
//view
export const PixelsMetaverseAbis1_User = async (
	contract: TContract,
	arg?: {
		addressParams1: string; //address
	}
...
//nonpayable
export const PixelsMetaverseAbis1_Register = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const PixelsMetaverseAbis1_SetConfig = async (
	contract: TContract,
	arg?: {
		role: string; //string
...
//view
export const PixelsMetaverseAbis1_GetMaterialLength = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PixelsMetaverseAbis1_GetMaterial = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverseAbis1_Make = async (
	contract: TContract,
	arg?: {
		name: string; //string
		category: string; //string
...
//nonpayable
export const PixelsMetaverseAbis1_ReMake = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
		num: string | number; //uint256
...
//nonpayable
export const PixelsMetaverseAbis1_Collect = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverseAbis1_CancelCollect = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
...
//view
export const PixelsMetaverseAbis1_GetCollection = async (
	contract: TContract,
	arg?: {
		from: string; //address
	}
...
//view
export const PixelsMetaverseAbis1_GetCompose = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverseAbis1_Compose = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverseAbis1_CancelCompose = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverseAbis1_Addition = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
...
//nonpayable
export const PixelsMetaverseAbis1_Subtract = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
		id: string | number; //uint256
...
//nonpayable
export const PixelsMetaverseAbis1_SetPMT721 = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverseAbis1_HandleTransfer = async (
	contract: TContract,
	arg?: {
		from: string; //address
		to: string; //address
