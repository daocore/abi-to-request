...
//view
export const SimpleTokenTruffle_DEFAULT_ADMIN_ROLE = async (
	contract: TContract,
) => {
...
//view
export const SimpleTokenTruffle_INITIAL_SUPPLY = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const SimpleTokenTruffle_MINTER_ROLE = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const SimpleTokenTruffle_PAUSER_ROLE = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const SimpleTokenTruffle_Allowance = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const SimpleTokenTruffle_Approve = async (
	contract: TContract,
	arg?: {
		spender: string; //address
...
//view
export const SimpleTokenTruffle_BalanceOf = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const SimpleTokenTruffle_Burn = async (
	contract: TContract,
	arg?: {
		amount: string | number; //uint256
	}
...
//nonpayable
export const SimpleTokenTruffle_BurnFrom = async (
	contract: TContract,
	arg?: {
		account: string; //address
		amount: string | number; //uint256
...
//view
export const SimpleTokenTruffle_Decimals = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const SimpleTokenTruffle_DecreaseAllowance = async (
	contract: TContract,
	arg?: {
		spender: string; //address
...
//view
export const SimpleTokenTruffle_GetRoleAdmin = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
	}
...
//view
export const SimpleTokenTruffle_GetRoleMember = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
...
//view
export const SimpleTokenTruffle_GetRoleMemberCount = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
	}
...
//nonpayable
export const SimpleTokenTruffle_GrantRole = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
		account: string; //address
...
//view
export const SimpleTokenTruffle_HasRole = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
		account: string; //address
...
//nonpayable
export const SimpleTokenTruffle_IncreaseAllowance = async (
	contract: TContract,
	arg?: {
		spender: string; //address
...
//nonpayable
export const SimpleTokenTruffle_Mint = async (
	contract: TContract,
	arg?: {
		to: string; //address
		amount: string | number; //uint256
...
//view
export const SimpleTokenTruffle_Name = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const SimpleTokenTruffle_Pause = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const SimpleTokenTruffle_Paused = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const SimpleTokenTruffle_RenounceRole = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
		account: string; //address
...
//nonpayable
export const SimpleTokenTruffle_RevokeRole = async (
	contract: TContract,
	arg?: {
		role: string; //bytes32
		account: string; //address
...
//view
export const SimpleTokenTruffle_SupportsInterface = async (
	contract: TContract,
	arg?: {
...
//view
export const SimpleTokenTruffle_Symbol = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const SimpleTokenTruffle_TotalSupply = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const SimpleTokenTruffle_Transfer = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const SimpleTokenTruffle_TransferFrom = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const SimpleTokenTruffle_Unpause = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
